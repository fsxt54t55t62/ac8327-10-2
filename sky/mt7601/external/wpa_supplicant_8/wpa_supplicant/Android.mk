...
## NOTE:
## Must put MTK CFLAGS after the first
## L_CFLAGS to avoid overlay by
## L_CFLAGS = -DWPA_IGNORE_CONFIG_ERRORS
...
#CONFIG_MTK_SCC always configured except BSP package
$(warning value of MTK_BSP_PACKAGE $(MTK_BSP_PACKAGE))
...
#MTK EAP-SIM/AKA customized feature
L_CFLAGS += -DCONFIG_MTK_EAP_SIM_AKA
...
INCLUDES += vendor/atc/proprietary/hardware/connectivity/wapi
endif
endif
LOCAL_CFLAGS := $(L_CFLAGS)
